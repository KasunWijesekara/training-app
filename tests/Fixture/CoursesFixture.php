...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mainimage' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'mainimage' => 'Lorem ipsum dolor sit amet',
            'created' => '2018-01-27 01:34:16',
            'status' => 1
        ],
    ];
}
